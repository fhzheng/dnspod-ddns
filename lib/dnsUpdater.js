var Dnspod = require('dnspod-client'),
    ...
    async = require('async'),
    messageSender = require("./messageSender").default;
...
function sendMessage(domain, ip){
    var email_msg = require("../msg_proto/email");
    // email_msg.
}
    ...
    async.waterfall([
        ...
        function (error, callback) {
            if (error) {
                ...
                sendMessage(self.params.domain, self.params.record_value);
            }
        }
    ], function (err) {
        if (err) {
